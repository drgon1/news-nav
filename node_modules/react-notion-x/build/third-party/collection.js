...
import {
  ...
  getBlockValue as getBlockValue8,
...
import "notion-types";
import { getBlockValue as getBlockValue3, getTextContent as getTextContent3 } from "notion-utils";
...
function CollectionCard({
  ...
  if ((cover == null ? void 0 : cover.type) === "page_content" || (cover == null ? void 0 : cover.type) === "page_content_first") {
    const contentBlockId = (_a = block.content) == null ? void 0 : _a.find((blockId) => {
      const block2 = getBlockValue3(recordMap.block[blockId]);
      return (block2 == null ? void 0 : block2.type) === "image";
    });
    if (contentBlockId) {
      const contentBlock = getBlockValue3(
      ...
      return /* @__PURE__ */ jsxs18(
        components.PageLink,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx55("div", { className: "notion-list-item-body", children: (_c = (_b = collectionView.format) == null ? void 0 : _b.list_properties) == null ? void 0 : _c.filter((p) => p.visible).map((p) => {
              var _a2;
              const schema = collection.schema[p.property];
...
// src/third-party/collection-view-table.tsx
import { Fragment as Fragment7, jsx as jsx56, jsxs as jsxs19 } from "react/jsx-runtime";
...
function Table({
  ...
  return /* @__PURE__ */ jsxs19("div", { className: "notion-table", style: tableStyle, children: [
    /* @__PURE__ */ jsx56("div", { className: "notion-table-view", style: tableViewStyle, children: !!properties.length && /* @__PURE__ */ jsxs19(Fragment7, { children: [
      ...
      /* @__PURE__ */ jsx56("div", { className: "notion-table-body", children: visibleBlockIds == null ? void 0 : visibleBlockIds.map((blockId) => /* @__PURE__ */ jsx56("div", { className: "notion-table-row", children: properties.map((p) => {
        var _a2, _b;
        const schema = (_a2 = collection.schema) == null ? void 0 : _a2[p.property];
        ...
        children: [
          /* @__PURE__ */ jsxs19(
            "svg",
            {
              ...
              strokeLinejoin: "round",
              children: [
                /* @__PURE__ */ jsx56("path", { d: "M12 5v14" }),
                /* @__PURE__ */ jsx56("path", { d: "m19 12-7 7-7-7" })
              ]
            }
          ),
          "Load more"
...
var CollectionView = React22.memo(CollectionViewImpl);

// src/third-party/collection.tsx
import { Fragment as Fragment8, jsx as jsx58, jsxs as jsxs20 } from "react/jsx-runtime";
...
function CollectionViewBlock({
  ...
  const [isMounted, setIsMounted] = React23.useState(false);
  React23.useEffect(() => {
    setIsMounted(true);
  }, []);
  ...
  const onChangeView = React23.useCallback(
    (collectionViewId2) => {
  ...
  const collection = getBlockValue8(recordMap.collection[collectionId]);
  const collectionView = getBlockValue8(
  ...
  const { width, padding } = React23.useMemo(() => {
    var _a2;
    const style = {};
  ...
  return /* @__PURE__ */ jsxs20(Fragment8, { children: [
    /* @__PURE__ */ jsxs20("div", { children: [
      ...
      showTitle && /* @__PURE__ */ jsx58("div", { className: "notion-collection-header", children: /* @__PURE__ */ jsxs20("div", { className: "notion-collection-header-title", children: [
        /* @__PURE__ */ jsx58(
          PageIcon,
          {
            block,
...
function CollectionViewTabs({
  ...
  const { recordMap } = useNotionContext();
  return /* @__PURE__ */ jsx58("div", { className: "notion-collection-view-tabs-row", children: viewIds.map((viewId) => /* @__PURE__ */ jsx58(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx58(
        ...
        {
          collectionView: getBlockValue8(recordMap.collection_view[viewId])
        }
      )
    },
    viewId
