...
import {
  ...
  getBlockValue as getBlockValue2,
  getListNestingLevel,
  getListNumber,
  getListStyle,
  ...
  switch (block.type) {
    ...
    case "header_4": {
      ...
      if (isH1) {
        ...
        headerBlock = /* @__PURE__ */ jsx32("h5", { className: classNameStr, "data-id": id, children: innerHeader });
      }
    ...
    case "numbered_list": {
      ...
      let output = null;
      const isTopLevel = block.type !== ((_j = getBlockValue2(recordMap.block[block.parent_id])) == null ? void 0 : _j.type);
    ...
    case "column": {
      ...
      const parent = getBlockValue2(recordMap.block[block.parent_id]);
    ...
    case "alias": {
      ...
      const linkedBlock = getBlockValue2(recordMap.block[blockPointerId]);
      if (!linkedBlock) {
    ...
    case "table_row": {
      const tableBlock = getBlockValue2(
...
function NotionBlockRenderer({
  ...
  const block = getBlockValue3(recordMap.block[id]);
  if (!block) {
    if (true) {
