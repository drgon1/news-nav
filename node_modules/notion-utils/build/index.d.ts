...
import { Block, ExtendedRecordMap, PageMap, Collection, CollectionView, User, NotionMapBox, BlockMap } from 'notion-types';
...
declare function getListNumber(blockId: string, blockMap: BlockMap): any;

declare function getListStyle(level: number): string;
...
declare function groupBlockContent(blockMap: BlockMap): string[][];
