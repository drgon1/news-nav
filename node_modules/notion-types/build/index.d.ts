...
interface Header4HeaderBlock extends BaseTextBlock {
    type: 'header_4';
    format?: {
        block_color: Color;
        toggleable?: boolean;
...
type CollectionCardCoverType = 'page_cover' | 'page_content' | 'page_content_first' | 'property' | 'none' | 'file';
