...
export declare type TaggedRecordOf<U extends UnionTypes<any, any>> = U['_TaggedRecord'];
...
export declare type MultiValueVariants<Record extends MultiValueRec<TagProp>, TagProp extends string> = {
...
export declare type MultiValueRec<TagProp extends string> = NoDefaultRec<{
    [tag: string]: any;
} & {
    [tag in TagProp]?: never;
}>;
...
export declare function unionize<Record extends MultiValueRec<TagProp>, TagProp extends string = 'tag'>(record: Record, config?: {
    tag: TagProp;
